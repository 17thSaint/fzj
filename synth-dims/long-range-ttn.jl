...
if true
	...
	#for tw2 in tws
		...
		#st = d["ttn"]
		params_dict = Dict([("hopping_anisotropy",1.0),("if_gpu",true),("particles",4),("layers",5),("mdim",600),("if_save_data",true),("filling",0.5),("onsite_strength",stren),("lr","all"),("if_periodic_phys",true),("if_periodic_synth",true)])
